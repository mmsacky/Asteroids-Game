...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        if self.radius <= ASTEROID_MIN_RADIUS:
            ...
            new_speed_1 = self.velocity.rotate(random_angle)
            new_speed_2 = self.velocity.rotate(-random_angle)
            ...
            new_asteroid_1.velocity = new_speed_1 * 1.2
            new_asteroid_2.velocity = new_speed_2 * 1.2
